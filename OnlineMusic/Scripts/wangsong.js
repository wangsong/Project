...
},run:function(){var a=arguments;this.each(function(c,b){if($type(c)=="function"){c.run(a);}});}});(function(){var b=["脌","脿","脕","谩","脗","芒","脙","茫","脛","盲","脜","氓","膫","膬","膭","膮","膯","膰","膶","膷","脟","莽","膸","膹","膼","膽","脠","猫","脡","茅","脢","锚","脣","毛","臍","臎","臉","臋","臑","臒","脤","矛","脥","铆","脦","卯","脧","茂","墓","暮","慕","木","艁","艂","脩","帽","艊","艌","艃","艅","脪","貌","脫","贸","脭","么","脮","玫","脰","枚","脴","酶","艖","艠","艡","艛","艜","艩","拧","艦","艧","艢","艣","扭","钮","扭","钮","泞","牛","脵","霉","脷","煤","脹","没","脺","眉","女","暖","鸥","每","媒","脻","沤","啪","殴","藕","呕","偶","脼","镁","脨","冒","脽","艗","艙","脝","忙","碌"];
